        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">ویرایش کاربر</h4>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input  name="FirstName" type="text" class="form-control"
                                               placeholder="نام کاربر را وارد کنید ..." value="{{$User->Firstname}}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input  name="LastName" type="text" class="form-control"
                                               placeholder="نام خانوادگی کاربر را وارد کنید ..." value="{{$User->Lastname}}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input  name="PhoneNumber" type="text" class="form-control"
                                               placeholder="شماره تلفن کاربر را وارد کنید ..." value="{{$User->PhoneNumber}}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-lg-10">
                                    <button type="submit" class="btn btn-primary">  بروزرسانی کاربر <i class="fa fa-save"></i></button>
                                </div>
                            </div>
                            </form>
